  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editData.status === 'closed') {
        showToast('Silver order moved to closed orders successfully!', 'success')
      } else {
        showToast('Silver order updated successfully!', 'success')
      }
      ...
      showToast('Error updating silver order', 'error')
    }
  }
