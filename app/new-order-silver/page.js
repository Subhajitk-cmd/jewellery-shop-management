...
export default function NewOrderSilver() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showNotification(`Silver order created successfully! Order ID: ${response.data.orderId}`, 'success')
      setTimeout(() => {
  ...
  return (
    <div className="form-container" style={{borderLeft: '4px solid #C0C0C0'}}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit" className="btn">Submit Silver Order</button>
      </form>
    </div>
  )
}